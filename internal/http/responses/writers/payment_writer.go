...
func (w *PaymentWriter) Response(_ context.Context, rw http.ResponseWriter, _ *http.Request,
	payload krouter.HttpPayload,
) error {
	var err error
	out := payload.Body.(responses.CreatePaymentResponse)
